...
function SaveItem() {
    ...
    var data = document.forms.OrderList.data.value;
...
function ModifyItem() {
    var name1 = document.forms.OrderList.name.value;
    var data1 = document.forms.OrderList.data.value;
...
//check if key exists
    if (localStorage.getItem(name1) !=null)
    {
        ...
        document.forms.OrderList.data.value = localStorage.getItem(name1);
    }
